...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, background: 'var(--mi-bg-void)', position: 'relative', overflow: 'hidden' }}>
      ...
      >
        <Image src="/images/logo/musical-insights-pro-logo-blue.png" width={120} height={27} alt="Home" style={{ objectFit: 'contain' }} />
      </Link>
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: 440, zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <Image src="/images/logo/musical-insights-pro-logo-blue.png" alt="Musical Insights Pro" width={220} height={50} priority style={{ objectFit: 'contain' }} />
